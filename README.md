...
Mustard ships a copy of Annotator.js in views/public, which is
dual-licensed under GNU GPLv3 and the MIT license (see
COPYING.annotator for more information about the license).
